...
form #logout{
 ...
 <div class="main-content" style="background-color:#FFC022;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1" style="color: white;">Tamil Nadu Covid19 Dashboard</h2>
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color:white;">Tamil Nadu Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color:white;">Tamil Nadu Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Tamil Nadu Death Cases</span>
                                                <h2 id="StateDeath" ></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="color: white;">Covid19 Cases In Tamil Nadu</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="color: white;">Covid19 Test Cases In Tamil Nadu</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=12c6L_QGgI4Zb7Oh9ugZaQQkaLIFrqK0u" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
...
$.ajax({
    ...
    var newArray = newArrayState[0].districtData.filter(function (el) {
      ...
      return ( el.district !== 'Foreign Evacuees' &&  el.district !== 'Others' && el.district !== 'Unknown');
    ...
    var conf_rate = (((StateConfirmed)*100)/(43387090));
