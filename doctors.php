  ...
  background-color: gray;
	...
	<section class="sample-text-area">
		<div class="container box_1170">
			<p class="sample-text" style="text-align: center;">
                Nam'ma TamilNadu offers its patients to choose from a wide network of well-qualified and experienced doctos across Tamil Nadu to ensure that the right healthcare decision is made.
			</p>
		</div>
	</section>
	<!-- End Sample Area -->
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Doctors In Tamil Nadu</h2>
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM doctors  WHERE state = 'tamil nadu' ";
