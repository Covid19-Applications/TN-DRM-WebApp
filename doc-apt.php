  ...
  color: white;
    ...
    <!-- header-start -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="background-color:  #005500;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading" style="color: white;">Patients Personal Details </h3>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading" style="color: white;">Doctor's Registration</h3>
